...
from apps.api.routers.frontend_api import router as frontend_router
...
api = NinjaAPI(
    title="Content Plan - PT Wijaya Inovasi Gemilang API",
    version="1.0.0",
    description=(
        "API Core for Content Plan (PT Wijaya Inovasi Gemilang) Social Media Management Platform.\n\n"
        "Integrates with Next.js Frontend and AI Agentic Protocols."
    ),
    auth=ApiKeyAuth(),
    docs=NoncedSwagger(),
...
api.add_router("/frontend", frontend_router, auth=None)
