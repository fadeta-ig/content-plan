...
# Database
DATABASES = {
    "default": env.db("DATABASE_URL", default="mysql://root:@localhost:3306/content_plan?charset=utf8mb4"),
}
...
# CSRF Trusted Origins for Next.js & Frontend API
...
MEDIA_LIBRARY_MAX_CONCURRENT_TRANSCODES = env.int("MAX_CONCURRENT_TRANSCODES", default=1)
