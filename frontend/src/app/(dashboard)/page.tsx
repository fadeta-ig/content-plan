      ...
      {loading ? (
        <div className="space-y-4 animate-pulse">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 ui-card space-y-3 p-4">
              <div className="h-4 w-44 bg-slate-200 rounded" />
              <div className="space-y-2 pt-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-14 bg-slate-50 border border-slate-100 rounded-lg p-2 flex justify-between items-center">
            ...
            <div className="ui-card space-y-3 p-4">
              ...
              <div className="space-y-2 pt-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-10 bg-slate-50 border border-slate-100 rounded p-2 flex justify-between items-center">
